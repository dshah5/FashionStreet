	...
	<div class="header_bg">
		<div class="wrap">
			<div class="header">
						...
						<li><a class="active-icon c1" href="#"><i>$0</i></a>
							<ul class="sub-icon1 list">
								<li><h3>shopping cart empty</h3>
									<a href=""></a></li>
								<li><p>
										if items in your wish list are missing, <a href="contact.jsp">contact
											us</a> to view them
									</p></li>
							</ul></li>
					</ul>
				...
				<div class="h_search">
					<form>
						<input type="text" id="searchText" value=""> <input
							type="submit" value="" id="searchButton">
		...
		<div class="wrap">
			<div class="header_sub">
				...
				<div class="top-nav">
					...
					<div class="clear"></div>
					<script
						src="${pageContext.request.contextPath}/js/responsive.menu.js"></script>
				</div>
				<div class="clear"></div>
			</div>
		</div>
				...
				<div class="contact">
					<div class="contact-form">
						...
						<form method="post" action="/FashionStreet/log">
							...
							<div>
								<span>Password</span> <span><input name="password"
		...
		<div class="wrap">
			<div class="footer">
				...
				<div class="grids_of_4">
					...
					<div class="grid1_of_4">
						<h4>
							<a href="service.jsp">About F Street</a>
						</h4>
					</div>
					<div class="grid1_of_4">
						<h4>
							<a href="service.jsp">Common Questions</a>
						</h4>
					</div>
					<div class="grid1_of_4">
						<h4>
							<a href="contact.jsp">Store Locator</a>
						</h4>
					</div>
					<div class="clear"></div>
				</div>
